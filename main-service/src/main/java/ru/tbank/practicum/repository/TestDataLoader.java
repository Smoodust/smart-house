...
public class TestDataLoader {
  ...
  public void init() {
    ...
    DeviceModel heater =
        createAndSaveDeviceModel("Heater", List.of(powerSetting, temperatureSetting));
    DeviceModel simpleLamp = createAndSaveDeviceModel("Simple Lamp", List.of(powerSetting));
    DeviceModel danceLamp =
        createAndSaveDeviceModel("Dance Lamp", List.of(powerSetting, colorHueSetting));
    DeviceModel blinds =
  ...
  private DeviceModel createAndSaveDeviceModel(
      String modelName, List<SettingDefinition> definitions) {
